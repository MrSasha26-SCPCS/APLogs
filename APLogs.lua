...
function APLogs:Init()
    if self.main.adminPanel.isServer then
        ...
        CS.HookManager.Add(self.main.adminPanel.gameObject, "onPlayerDeath", function(obj)
            ...
            "целиком|ник и ID <color=green>жертвы</color>|ник и ID <color=red>убийцы</color>", 
            "Игрок " .. obj[0].accountName .. "[`" .. obj[0].accountUID .. "`] был убит " .. obj[1].killer.accountName .. " [`" .. obj[1].killer.accountUID .. "`]|" ..
            "Ник: `" .. obj[0].accountName .. "`\nАйди: `" .. obj[0].accountUID .. "`|" ..
            "Ник: `" .. obj[1].killer.accountName .. "`\nАйди: `" .. obj[1].killer.accountUID .. "`")
        end)
